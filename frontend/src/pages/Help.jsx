...
export default function Help() {
  ...
  <ul>
    <li> <Title level={4}>2.1 Pareparation for trajecory file</Title></li>
    The NRIMD input can be prepared from outputs of mainstream Molecular Dynamics software GROMACS, AMBER, and NAMD. We provide instructions using Built-in commands, VMD, and Customized python scripts as follows:
      <ul>
        <li><Title level={5}>2.1.1 Built commands of MD software</Title></li>
          <ul>
          <li><h3>GROMACS</h3> <Gromacs/></li>
          <li><h3>AMBER</h3><Amber/></li>
          <li><h3>NAMD</h3><Namd/></li> 
          </ul>
        <li><Title level={5}>2.1.2 VMD</Title></li>
        <Vmd/>
        <li><Title level={5}>2.1.3 Python Script</Title></li>
        <Python/>
      </ul>
  ...
  <img src={check} style={{border:'3px solid #000',width:"90%"}}></img>
  <div>
  ...
  <img src={status} style={{width:'90%',border:'3px solid #000'}}></img>
  <div>
  ...
  <Title level={3}>4. Example Explanation</Title>
  <div>
    You can go to <Link to='/example'>Example Explanation</Link> page in the left menu, and follow it to learn submitting example trajectory, getting example result and example result explanation.
  </div>
  <Divider/>
